...
# ---------------------------------------------------------------------------
# Task 8 Part A — resolve_projector_backward is a no-op (no auto-promotion)
# ---------------------------------------------------------------------------


def test_resolve_is_noop_for_eigh():
    """User settings pass through unchanged — no silent overrides."""
