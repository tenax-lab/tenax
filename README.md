...
- **Auto-χ_E bump (variPEPS §2.8.2)** — opt-in reactive increase of CTM bond dimension when truncation error exceeds threshold (`CTMConfig.chi_auto_bump`); zero-pads the cached environment for a warm restart; mutually exclusive with `chi_ramp` (Naumann et al., SciPost Phys. Lect. Notes 86, 2024)
